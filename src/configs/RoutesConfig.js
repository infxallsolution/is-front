...
export const protectedRoutes = [
  ...
  {
    key: "planonomina",
    path: `${APP_PREFIX_PATH}/planos/planonomina`,
    component: React.lazy(() =>
      import("views/app-views/plains/PlanoNomina")
    ),
  },
  {
    key: "planosalidas",
    path: `${APP_PREFIX_PATH}/planos/planosalidas`,
    component: React.lazy(() =>
      import("views/app-views/plains/PlanoSalidas")
    ),
  },
  {
    key: "formats",
    path: `${APP_PREFIX_PATH}/planos/formats`,
    component: React.lazy(() =>
      import("views/app-views/plains/formats")
    ),
  }
];