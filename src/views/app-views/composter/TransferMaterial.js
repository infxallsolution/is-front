...
import { DeleteOutlined, NumberOutlined, ClockCircleOutlined , PlusSquareOutlined, SearchOutlined } from '@ant-design/icons';
      ...
      <div className=" row ">
        ...
        <Row gutter={[8, 8]}>
          ...
          >
            ...
            <Divider orientation="left">Movimiento de material.</Divider>
                ...
                <Row gutter={16}>
                  ...
                  <Col className="gutter-row" span={12}>
                    <Form.Item
                      label="Lote entrada"
                      name="destination"
                      rules={[{ required: true, message: 'Destino requerido' }]}
                    >
                      <Select
                        disabled={false}
                        style={{ width: '100%' }}
